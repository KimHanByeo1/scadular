...
//   RxList<Schedule> _getEventsForDay(DateTime day, schedules) {
//     final events = _getEventsMap(schedules);
//     final date = DateTime(day.year, day.month, day.day).toLocal();
//     RxList<Schedule> rxEventsList = events[date].obs ?? [].obs;
//     return rxEventsList;
//   }

//   RxMap _getEventsMap(List<Schedule> schedules) {
//     final RxMap events = {}.obs;
